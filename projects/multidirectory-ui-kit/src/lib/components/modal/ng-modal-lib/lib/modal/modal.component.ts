...
export class ModalComponent implements AfterViewChecked {
  ...
  @Input() dontDestroyOnClose = false;
  @Input() minHeight = 0;
  ...
  @ContentChild('appModalBody', { descendants: true, static: true })
  bodyTemplateRef!: TemplateRef<any>;
  @ContentChild('appModalHeader', { descendants: true, static: true })
  headerTemplateRef!: TemplateRef<any>;
  @ContentChild('appModalFooter', { descendants: true, static: true })
