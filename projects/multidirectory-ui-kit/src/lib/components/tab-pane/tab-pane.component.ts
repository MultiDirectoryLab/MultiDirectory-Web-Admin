import { AfterViewInit, Component, ContentChild, ContentChildren, ElementRef, EventEmitter, Input, OnDestroy, OnInit, Output, QueryList, Renderer2, TemplateRef, ViewChildren, ViewEncapsulation } from "@angular/core";
...
export class TabPaneComponent implements AfterViewInit, OnDestroy {
    ...
    trackSelection() {
        ...
        this.lastSubscription = merge(...selections).pipe(
