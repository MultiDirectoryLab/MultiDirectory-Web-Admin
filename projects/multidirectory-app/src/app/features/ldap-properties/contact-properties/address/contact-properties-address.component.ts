...
@Component({
  selector: 'app-contact-properties-address',
  templateUrl: './contact-properties-address.component.html',
  styleUrls: ['./contact-properties-address.component.scss'],
  imports: [TranslocoPipe, TextareaComponent, FormsModule, TextboxComponent, DropdownComponent],
})
export class ContactPropertiesAddressComponent implements AfterViewInit, OnDestroy {
  @Input() accessor: LdapAttributes = {};
  unsubscribe = new Subject();
  countries = [new DropdownOption({ title: 'Russia', value: 'Russia' }), new DropdownOption({ title: 'Kazakhstan', value: 'Kazakhstan' })];
