...
const LdapPropertyTypeMap: LdapPropertyDescription[] = [
    ...
    { id: '1.3.6.1.4.1.1466.115.121.1.15', description: 'Directory String', type: LdapPropertyType.String, isArray: false },
    { id: '1.3.6.1.4.1.1466.115.121.1.38', description: 'Multivalued String', type: LdapPropertyType.MultivaluedString, isArray: true }
]
